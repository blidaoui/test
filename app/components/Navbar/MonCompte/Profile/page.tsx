  ...
  return (
    ...
    <Container>
      ...
      <div className="col-span-1 w-[70%] justify-self-end">
          <div className=" relative justify-content border-[1.2px] border-slate-400 bg-gray-700  text shadow-md  rounded-xl ml-4 mt-4 mr-4 mt-1  ">
          ...
          <div className=" relative justify-content border-[1.2px] border-slate-400 bg-gray-700  text shadow-md  rounded-t-xl ml-4 mr-4 mt-4 ">
          ...
          <div className=" relative justify-content border-[1.2px] border-slate-400  shadow-md  rounded-b-xl ml-4 mr-4 mb-4">
          <div className="grid flex-row p-2 justify-between ">
